...
class OverviewControllerTest extends TestCase
{
	...
	public function testIndex()
	{
		...
		$this->assertNotEmpty($response['data'][TeamsMatch::STATUS_UPCOMING]['home']);
		$this->assertNotNull($response['data'][TeamsMatch::STATUS_UPCOMING]['home']['id']);
		$this->assertNotEmpty($response['data'][TeamsMatch::STATUS_UPCOMING]['home']['name']);
		$this->assertNotNull($response['data'][TeamsMatch::STATUS_UPCOMING]['home']['name']['original']);
		$this->assertNotNull($response['data'][TeamsMatch::STATUS_UPCOMING]['home']['name']['short']);
		$this->assertNotEmpty($response['data'][TeamsMatch::STATUS_UPCOMING]['away']);
		$this->assertNotNull($response['data'][TeamsMatch::STATUS_UPCOMING]['away']['id']);
		$this->assertNotEmpty($response['data'][TeamsMatch::STATUS_UPCOMING]['away']['name']);
		$this->assertNotNull($response['data'][TeamsMatch::STATUS_UPCOMING]['away']['name']['original']);
		$this->assertNotNull($response['data'][TeamsMatch::STATUS_UPCOMING]['away']['name']['short']);
