...
class TeamControllerTest extends TestCase
{
	...
	public function testOverview()
	{
		...
		$this->assertNotNull($response['data']['nextMatch']['status']);
	...
	public function testFavorite()
	{
		...
		$this->assertNotNull($response['data']['nextMatch']['stage']['id']);
		$this->assertNotNull($response['data']['nextMatch']['tournament']['id']);
		$this->assertNotNull($response['data']['previousMatch']['id']);
		$this->assertNotNull($response['data']['previousMatch']['homeTeam']['id']);
		$this->assertNotNull($response['data']['previousMatch']['homeTeam']['name']['full']);
		$this->assertNotNull($response['data']['previousMatch']['homeTeam']['name']['short']);
		$this->assertNotNull($response['data']['previousMatch']['awayTeam']['id']);
		$this->assertNotNull($response['data']['previousMatch']['awayTeam']['name']['full']);
		$this->assertNotNull($response['data']['previousMatch']['awayTeam']['name']['short']);
		$this->assertNotNull($response['data']['previousMatch']['competition']['id']);
		$this->assertNotNull($response['data']['previousMatch']['competition']['name']);
		$this->assertNotNull($response['data']['previousMatch']['date']);
		$this->assertNotNull($response['data']['previousMatch']['status']);
		$this->assertNotNull($response['data']['previousMatch']['coverage']);
		$this->assertNotNull($response['data']['previousMatch']['result']['total']['home']);
		$this->assertNotNull($response['data']['previousMatch']['result']['total']['away']);
		$this->assertNotNull($response['data']['previousMatch']['result']['penalty']['away']);
		$this->assertNotNull($response['data']['previousMatch']['result']['penalty']['home']);
		$this->assertNotNull($response['data']['previousMatch']['competition']['id']);
		$this->assertNotNull($response['data']['previousMatch']['competition']['name']);
		$this->assertNotNull($response['data']['previousMatch']['stage']['id']);
		$this->assertNotNull($response['data']['previousMatch']['tournament']['id']);
