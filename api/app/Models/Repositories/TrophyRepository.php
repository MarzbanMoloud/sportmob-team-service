...
class TrophyRepository extends DynamoDBRepository implements DynamoDBRepositoryInterface
{
	 ...
	 * @return array|null
	 */
	public function findByCompetition(string $competitionId, string $tournamentId, string $teamId)
	{
		try {
			$Result = $this->dynamoDbClient->query( [
				'TableName'                 => static::getTableName(),
				'IndexName'                 => self::TROPHY_COMPETITION_TOURNAMENT_INDEX,
				'KeyConditionExpression'    => 'competitionId = :competition and tournamentId = :tournament',
